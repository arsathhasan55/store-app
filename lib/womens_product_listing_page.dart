...
class WomensProductListingPage extends StatefulWidget {
  const WomensProductListingPage({super.key});

  @override
  State<WomensProductListingPage> createState() => _WomensProductListingPageState();
}

class _WomensProductListingPageState extends State<WomensProductListingPage> {
  final List<String> _subCategories = ['All', 'Tops', 'Pants', 'Shoes'];
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: "Search women's styles...",
              ...
              Expanded(
                child: StreamBuilder<List<ProductModel>>(
                  stream: context.read<ProductService>().getProductsByCategory('women'),
                    ...
                    if (products.isEmpty) {
                      return Center(
                        child: Column(
                          ...
                          children: [
                            const Icon(Icons.checkroom_outlined, size: 60, color: Colors.white24),
